...
```idl
{{include:idl/v1.8/examples/neural_example.idl}}
```
...
```idl
{{include:idl/v1.8/examples/agent_example.idl}}
```
...
```idl
{{include:idl/v1.8/provisional/rf_beam.idl}}
```
...
```idl
{{include:idl/v1.8/provisional/radio.idl}}
```
