...
Welcome to the SpatialDDS spec browser. Use the navigation to jump between the 1.6 draft, 1.5 release, 1.4 release, 1.3 release, and 1.2 release, or jump straight into the aggregated single-page versions linked below.
...
- [SpatialDDS 1.6 (single page)](SpatialDDS-1.6-full.md)
