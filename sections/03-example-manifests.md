...
```json
{{include:manifests/vps_manifest.json}}
```
...
```json
{{include:manifests/mapping_service_manifest.json}}
```
...
```json
{{include:manifests/content_experience_manifest.json}}
```
...
```json
{{include:manifests/anchors_manifest.json}}
```
